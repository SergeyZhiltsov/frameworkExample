...
public class TestInfo {
    ...
    public static void printResults(){
        Driver.site.logger.log.info("Test ID: "+id());
        Driver.site.logger.log.info("Test Name: "+name());
        Driver.site.logger.log.info("Test Suite: "+suite());
    }
}
